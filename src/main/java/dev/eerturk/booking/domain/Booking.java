...
class Booking {
    ...
    @OneToMany(mappedBy = "booking", cascade = {CascadeType.PERSIST, CascadeType.REFRESH, CascadeType.MERGE}, orphanRemoval = true)
    ...
    public void initDates() {
        List<BookingDate> bookingDates = getStartDate()
