...
public record CreateBookingRequest(
        ...
        @Positive(message = "The guest id must be greater than zero")
        Long guestId) {

        public static CreateBookingRequest of(Long propertyId, LocalDate startDate, LocalDate endDate, Long guestId) {
