...
class BookingApiApplicationTests {
  ...
  void shouldCreateAndListBookings() {
    ...
    var toCreate =
        CreateBookingRequest.of(
            propertyId, LocalDate.now().plusDays(10), LocalDate.now().plusDays(20), 5l);
    BookingDetailResponse expected =
        webTestClient
            ...
            .expectStatus()
            .isCreated()
            .expectBody(BookingDetailResponse.class)
            .value(
                booking -> {
  ...
  void shouldAllowOverlapBlockCreation() {
    var toCreate =
        CreateBookingRequest.of(
            ...
            LocalDate.now().plusDays(20),
            null);
    BookingDetailResponse booking1 =
        webTestClient
            .post()
            .uri("/bookings")
            .bodyValue(toCreate)
    ...
    BookingDetailResponse booking2 =
        webTestClient
            .post()
            .uri("/bookings")
            .bodyValue(
    ...
    BookingDetailResponse booking3 =
        webTestClient
            .post()
            .uri("/bookings")
            .bodyValue(
  ...
  void shouldCreateNewBookingWhenExistingOneCancelled() {
    var toCreate =
        CreateBookingRequest.of(
            ...
            LocalDate.now().plusDays(20),
            5l);
    BookingDetailResponse toCancel =
        webTestClient
            .post()
            .uri("/bookings")
            .bodyValue(toCreate)
